...
# Ignora a criação do userdata.img, já que o F2FS é formatado no primeiro boot
# e a ausência de conteúdo (o que o log mostra) causa a falha.
#BOARD_SUPPRESS_SECURE_IMGS := true
